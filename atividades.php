...
<head>
    ...
    <style>
        ...
        .badge-status.pendente { background: rgba(245, 158, 11, 0.15); color: #b45309; }
        .badge-status.em_execucao { background: rgba(14, 165, 233, 0.15); color: #0369a1; }
        .badge-status.concluida { background: rgba(16, 185, 129, 0.15); color: #047857; }
    </style>
</head>
<body>
    <div class="sidebar">
