...
<head>
    ...
    <style>
        ...
        .evento-card.planejado { border-left-color: #6c757d; }
        .evento-card.em_andamento { border-left-color: var(--primary-color); }
        .evento-card.concluido { border-left-color: var(--success-color); }
        .evento-card.cancelado { border-left-color: var(--danger-color); }
