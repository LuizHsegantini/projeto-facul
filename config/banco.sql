...
ALTER TABLE equipe_membros 
ADD data_atualizacao TIMESTAMP NOT NULL DEFAULT NOW();

ALTER TABLE equipe_membros 
ADD data_inclusao TIMESTAMP NOT NULL DEFAULT NOW();
...
alter table eventos 
MODIFY data_fim_evento DATETIME;
